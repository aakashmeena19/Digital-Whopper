...
const Timeline = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.5 } // jab 50% section screen me ho tab trigger
    );
  ...
  return (
    <div
      ref={timelineRef}
      className="flex justify-center items-center h-[400px] bg-gray-300 my-40"
    >
      <div className="relative w-[4px] h-[350px]">
